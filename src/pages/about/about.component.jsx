          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
                <Row className="align-items-start p-2 my-details rounded">
                  ...
                  <br />I have received my B.S Degree at the University of Minnesota, Twin Cities in 2014. I have a successful record of my academic achievments majoring Sustainable Systems Management and minoring Management at Carlson School of Management.<br />
                ...
                <Row>
                  ...
                  <Col className="d-flex justify-content-center flex-wrap">
                    ...
                    <div>
                    <a href="https://drive.google.com/file/d/1Ug-gFKI_9nGSwo75HXxxnyUON9s3DvyM/view?usp=sharing" target="_blank" rel="noopener noreferrer">
